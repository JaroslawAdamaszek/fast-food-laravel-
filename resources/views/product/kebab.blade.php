...
@section('content')
    <div class="container">
        <div class="row row-centered pos">
            <div class=" card col-lg-6 col-xs-12 m-auto">
                ...
                <form action="{{route('product.store')}}" method="POST">
                    <div class="d-flex align-items-center justify-content-center form-check">
                        <input class="form-check-input" type="radio" name="name" value="kebab" id="flexRadioDefault1"
                               checked>
                    ...
                    <div class="card-body">
                        {{ csrf_field() }}
                        <div class="">
                            @foreach(\App\Http\Controllers\IngredientsController::index('kebab') as $type => $ingredients)
